...
/* makes the robot go forward for as long as the time sent in is*/
...
/* Turns the robot to the left for as long as the time sent in is*/
...
/* Turns the robot to the right for as long as the time sent in is*/
...
/* Checks to see if there is an obstacle in front of the robot, if so travels around the obstacle*/
